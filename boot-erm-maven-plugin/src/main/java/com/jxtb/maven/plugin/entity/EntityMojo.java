package com.jxtb.maven.plugin.entity;
...
import com.jxtb.maven.plugin.ERMImporter;
import com.jxtb.maven.plugin.GeneralFileContent;
import com.jxtb.maven.plugin.Generator;
import com.jxtb.maven.plugin.GeneratorUtils;
import com.jxtb.maven.plugin.mete.*;
import com.jxtb.maven.plugin.mete.*;
...
public class EntityMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        String targetBasePackage = this.targetModule;
    ...
    private List<CompilationUnit> generateEntity(Database db, String basePackage) {
        ...
        for (Table table : db.getTables()) {
            table.setJavaClass(new FullyQualifiedJavaType(basePackage + ".infrastructure." + JavaBeansUtil.getCamelCaseString(table.getDbName(), true)));
